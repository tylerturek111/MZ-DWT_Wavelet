...
# -------------------------------
# alpha_and_behavior_jumps
# Determine location of jump singularities based on behavior and alpha
# transform_array  : 2-D Numpy Array
#                    The wavelet transform array
# jump_threshold   : integer
#                    The threshold above which to flag jumps
...
#                    The alpha threshold below which jumps are flagged
# RETURNS, returns : 1-D Numpy Array of integers
#                    The indexes of jumps flagged by behavior and alpha
# returns, RETURNS : 1-D Numpy Array of floats
#                    The alpha values at every time point
# -------------------------------
def alpha_and_behavior_jumps(transform_array, jump_threshold, alpha_threshold):
    # Getting location of jumps based on behavior
    behavior_jumps = compute_jump_locations(transform_array, jump_threshold)
    
    # Getting alpha values
    alpha_values = efficient_compute_alpha_values(transform_array, 1, behavior_jumps)
    
    # Finding potential jumps based on alpha
    alpha_jumps = compute_alpha_indexes(alpha_values, alpha_threshold)
