...
compressed_alpha_values = Jump_Analysis.efficient_compute_alpha_values(compressed_wavelet_transform, 1, np.array([19, 39]))
...
compressed2_alpha_values = Jump_Analysis.efficient_compute_alpha_values(compressed_wavelet_transform, 1, np.array([19, 39]))
